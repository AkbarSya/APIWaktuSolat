...
@section('content')
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center green-text darken-1">عرض الشهر
</h1>
      ...
      <div class="row center">
        <a href="{{ url('/') }}" id="download-button" class="btn-large waves-effect waves-light green darken-3">Lihat Versi Harian</a>
      </div>
      <br><br>
    </div>
  </div>
  ...
  <div class="container">
    <div class="section">
      <div class="row center-align">
        <table id="tableMonthly" style="color:#43a047 ">
          <thead>
            <tr>
              <th data-field="no">#</th>
              <th data-field="tanggal">Tanggal</th>
              <th data-field="fajr">Shubuh</th>
              <th data-field="dhuhr">Dzuhur</th>
              <th data-field="asr">Ashar</th>
              <th data-field="maghrib">Maghrib</th>
              <th data-field="isha">Isya</th>
            </tr>
          </thead>
          <tbody>
